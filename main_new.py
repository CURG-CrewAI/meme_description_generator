...
def main():
    ...
    # 팀원 에이전트로부터 받은 입력 예시
    keyword = "귀멸의 칼날"
    why_trending = "A Korean man has been arrested for illegally filming the popular Japanese anime Demon Slayer: Kimetsu no Yaiba the Movie: Mugen-sei-hen at a local theater."
